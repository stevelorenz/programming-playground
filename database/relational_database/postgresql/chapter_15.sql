...
-- This syntax to create function is amazing...
...
-- The Python3 version is installed.
CREATE EXTENSION plpython3u;

-- Create a function with Python3
CREATE OR REPLACE FUNCTION trim_country(input_string text)
RETURNS text AS $$
	import re
	cleaned = re.sub(r' Country', '', input_string)
$$ LANGUAGE plpython3u;
...
DROP TABLE us_counties_2000 CASCADE;
