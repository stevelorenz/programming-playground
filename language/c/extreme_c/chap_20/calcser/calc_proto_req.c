...
method_t str_to_method(const char *str)
{
	if (!strcmp(str, GETMEM_STR))
		return GETMEM;
	if (!strcmp(str, RESMEM_STR))
		return RESMEM;
	if (!strcmp(str, ADD_STR))
		return ADD;
	if (!strcmp(str, ADDM_STR))
		return ADDM;
	if (!strcmp(str, SUB_STR))
		return SUB;
	if (!strcmp(str, SUBM_STR))
		return SUBM;
	if (!strcmp(str, MUL_STR))
		return MUL;
	if (!strcmp(str, MULM_STR))
		return MULM;
	if (!strcmp(str, DIV_STR))
		return DIV;
	return 0;
}
