...
/*
 * AMAZING: Add my amazing "hello world" syscall!
 * */

/**
 * @param str: A pointer to the input string.
 * @param str_len: The length of the input string.
 * @param buf: A pointer to the output string.
 * @param buf_len: The length of the output string.
 */
asmlinkage long sys_helloworld(const char __user *str, const size_t str_len,
			       char __user *buf, size_t buf_len);
